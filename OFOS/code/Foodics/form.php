    ...
    <form id="form" method="POST" action="">
          ...
          <fieldset> 
            ...
            <br><br> 
              <tr>
                  <td colspan="2">
                  <a href="" onclick="showMessage()"><button type="submit" id="log"name="reg_user">  Submit</button> </a> 
    ...
    if (isset($_POST['reg_user'])) {
        ...
        $password_2 = mysqli_real_escape_string($conn, $_POST['password_2']);
          ...
          if ($password_1 == $password_2) {
            $sql1="INSERT INTO userinfo(firstname,lastname,username,PASSWORD,contactno,email) values('$firstname','$lastname','$username','$password_1','$contactno','$email')";
              if ($conn->query($sql1) === TRUE) {
          
                   //create a session variable to display massege
          
            header("location:http://localhost/foodics/login.php");
        } else {
          
              //create a session variable to display massege
             
              header("location:http://localhost/foodics/form.php");  
        }
